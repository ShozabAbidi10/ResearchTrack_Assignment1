...
assignmen1_controller package have one ROS node with name assignment1_controller as well. For this node there is a cpp file with name assignment1_controller.cpp. This node perform following functionalities:
...
1. This node implement a ROS server which in request ask for the min and max value of coordinates
